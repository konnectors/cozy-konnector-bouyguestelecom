[Cozy][cozy]’s Bouygues Telecom Konnector
=========================================
...
git://github.com/cozy/cozy-konnector-bouyguestelecom.git#build
...
nicofrand, Peltoche, and Chocobuzz have contributed to it.
